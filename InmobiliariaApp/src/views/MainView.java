    ...
    public void start(Stage primaryStage) {
     ...
     private void showRegistroClienteArrendatarioForm() {
        ...
        submitButton.setOnAction(e -> {
            ClienteArrendatario nuevoCliente = new ClienteArrendatario(
                    nombreField.getText(),
                    telefonoField.getText(),
                    direccionField.getText(),
                    profesionField.getText(),
                    lugarTrabajoField.getText(),
                    Integer.parseInt(salarioField.getText()),  // Asegúrate de que esto coincida con el tipo en tu modelo
                    barrioField.getText(),
                    zonaField.getText(),
                    Integer.parseInt(precioAlquilerField.getText()),  // Asegúrate de que esto coincida con el tipo en tu modelo
                    propiedadAlquiladaField.getText()
            );
